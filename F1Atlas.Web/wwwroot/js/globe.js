...
function yi(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (xi(i)) i.isRenderTargetTexture ? (H("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var wi = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Ti, this.fragmentShader = Ei, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var Mi = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = ji(t, this.TimeBufferType), this.values = ji(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new Ii(this.times, this.values, this.getValueSize(), e);
...
Li.prototype.ValueTypeName = "", Li.prototype.TimeBufferType = Float32Array, Li.prototype.ValueBufferType = Float32Array, Li.prototype.DefaultInterpolation = R;
var Ri = class extends Li {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ri.prototype.ValueTypeName = "bool", Ri.prototype.ValueBufferType = Array, Ri.prototype.DefaultInterpolation = Me, Ri.prototype.InterpolantFactoryMethodLinear = void 0, Ri.prototype.InterpolantFactoryMethodSmooth = void 0;
var zi = class extends Li {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
zi.prototype.ValueTypeName = "color";
...
Hi.prototype.ValueTypeName = "quaternion", Hi.prototype.InterpolantFactoryMethodSmooth = void 0;
var Ui = class extends Li {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ui.prototype.ValueTypeName = "string", Ui.prototype.ValueBufferType = Array, Ui.prototype.DefaultInterpolation = Me, Ui.prototype.InterpolantFactoryMethodLinear = void 0, Ui.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Gi = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (Ki(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !Ki(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var qi = /*@__PURE__*/ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? qi : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var Yi = /* @__PURE__ */ new WeakMap(), Xi = class extends Ji {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = Gi.get(`image:${e}`);
		if (a !== void 0) {
		...
		function s() {
			...
			Yi.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			l(), r && r(t), Gi.remove(`image:${e}`);
			let n = Yi.get(this) || [];
			for (let e = 0; e < n.length; e++) {
				let r = n[e];
				r.onError && r.onError(t);
			}
			Yi.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
			o.removeEventListener("load", s, !1), o.removeEventListener("error", c, !1);
		}
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), Gi.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, Zi = class extends Ji {
	constructor(e) {
		super(e);
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(Qi, $i, ea), ea.x === 1 && ea.y === 1 && ea.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Qi, $i, ea.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(Qi, $i, ea), ea.x === 1 && ea.y === 1 && ea.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Qi, $i, ea.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, na = /*@__PURE__*/ new q(), ra = /*@__PURE__*/ new K(), ia = /*@__PURE__*/ new K(), aa = class extends ta {
	...
	getViewBounds(e, t, n) {
		na.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(na.x, na.y).multiplyScalar(-e / na.z), na.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(na.x, na.y).multiplyScalar(-e / na.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, ra, ia), t.subVectors(ia, ra);
	}
...
}, sa = -90, ca = 1, la = class extends xn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new aa(sa, ca, e, t);
		r.layers = this.layers, this.add(r);
		let i = new aa(sa, ca, e, t);
		i.layers = this.layers, this.add(i);
		let a = new aa(sa, ca, e, t);
		a.layers = this.layers, this.add(a);
		let o = new aa(sa, ca, e, t);
		o.layers = this.layers, this.add(o);
		let s = new aa(sa, ca, e, t);
		s.layers = this.layers, this.add(s);
		let c = new aa(sa, ca, e, t);
...
}, da = "\\[\\]\\.:\\/", fa = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), pa = "[^\\[\\]\\.:\\/]", ma = "[^" + da.replace("\\.", "") + "]", ha = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", pa), ga = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", ma), _a = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", pa), va = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", pa), ya = RegExp("^" + ha + ga + _a + va + "$"), ba = [
	"material",
	"materials",
	"bones",
	"map"
...
var Ca = /*@__PURE__*/ new qt(), wa = class {
	...
	setFromXRController(e) {
		return Ca.identity().extractRotation(e.matrixWorld), this.ray.origin.setFromMatrixPosition(e.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(Ca), this;
	}
	intersectObject(e, t = !0, n = []) {
		return Ea(e, this, n, t), n.sort(Ta), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) Ea(e[r], this, n, t);
		return n.sort(Ta), n;
	}
};
function Ta(e, t) {
...
function Ea(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) Ea(r[e], t, n, !0);
	}
}
var Da = class {
...
var Z = {
	...
	points: {
		uniforms: /*@__PURE__*/ bi([Q.points, Q.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ bi([Q.common, Q.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ bi([Q.sprite, Q.fog]),
...
Na.physical = {
	uniforms: /*@__PURE__*/ bi([Na.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Pa = {
	...
	b: 0,
	g: 0
}, Fa = /*@__PURE__*/ new qt(), Ia = /*@__PURE__*/ new J();
...
function La(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new qr(new gi(1, 1, 1), new Di({
			name: "BackgroundCubeMaterial",
			uniforms: yi(Na.backgroundCube.uniforms),
			vertexShader: Na.backgroundCube.vertexShader,
			fragmentShader: Na.backgroundCube.fragmentShader,
			side: 1,
			depthTest: !1,
			depthWrite: !1,
			fog: !1,
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(Fa.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(Ia), l.material.toneMapped = Y.getTransfer(i.colorSpace) !== ze, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new qr(new _i(2, 2), new Di({
			name: "BackgroundMaterial",
			uniforms: yi(Na.background.uniforms),
			vertexShader: Na.background.vertexShader,
			fragmentShader: Na.background.fragmentShader,
			side: 0,
			depthTest: !1,
			depthWrite: !1,
			fog: !1,
	...
	function g(t, r) {
		t.getRGB(Pa, Ci(e)), n.buffers.color.setClear(Pa.r, Pa.g, Pa.b, r, a);
	}
	function _() {
...
var Ha = 4, Ua = [
	...
	.526,
	.582
], Wa = 20, Ga = 256, Ka = /*@__PURE__*/ new oa(), qa = /*@__PURE__*/ new X(), Ja = null, Ya = 0, Xa = 0, Za = !1, Qa = /*@__PURE__*/ new q(), $a = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Qa } = i;
		Ja = this._renderer.getRenderTarget(), Ya = this._renderer.getActiveCubeFace(), Xa = this._renderer.getActiveMipmapLevel(), Za = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Ja, Ya, Xa), this._renderer.xr.enabled = Za, e.scissorTest = !1, no(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ja = this._renderer.getRenderTarget(), Ya = this._renderer.getActiveCubeFace(), Xa = this._renderer.getActiveMipmapLevel(), Za = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = eo(r)), this._blurMaterial = io(r, e, t), this._ggxMaterial = ro(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
	...
	_sceneToCubeUV(e, t, n, r, i) {
		...
		c.getClearColor(qa), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new qr(new gi(), new Fr({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(qa), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			no(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = oo()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = ao());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		no(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Ka);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - Ha ? n - d + Ha : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, no(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, Ka), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, no(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, Ka);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / 39, p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : Wa;
		m > Wa && H(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Wa}`);
		let h = [], g = 0;
		for (let e = 0; e < Wa; ++e) {
		...
		no(t, 3 * v * (r > _ - Ha ? r - _ + Ha : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, Ka);
	}
};
function eo(e) {
	let t = [], n = [], r = [], i = e, a = e - Ha + 1 + Ua.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - Ha ? s = Ua[o - e + Ha - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new wr();
		h.setAttribute("position", new lr(f, 3)), h.setAttribute("uv", new lr(p, 2)), h.setAttribute("faceIndex", new lr(m, 1)), r.push(new qr(h, null)), i > Ha && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function io(e, t, n) {
	let r = new Float32Array(Wa), i = new q(0, 1, 0);
	return new Di({
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new $a(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new $a(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function vo(e, t, n, r, i, a) {
	...
	let l = new Oi({
		...
		depthTest: !1,
		depthWrite: !1
	}), u = new qr(c, l), d = new oa(-1, 1, 1, -1, 0, 1), f = null, p = null, m = !1, h, g = null, _ = [], y = !1;
...
var yo = /*@__PURE__*/ new Vt(), bo = /*@__PURE__*/ new pi(1, 1), xo = /*@__PURE__*/ new Gt(), So = /*@__PURE__*/ new Kt(), Co = /*@__PURE__*/ new fi(), wo = [], To = [], Eo = /* @__PURE__ */ new Float32Array(16), Do = /* @__PURE__ */ new Float32Array(9), Oo = /* @__PURE__ */ new Float32Array(4);
function ko(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = wo[i];
	if (a === void 0 && (a = new Float32Array(i), wo[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function Mo(e, t) {
	let n = To[t];
	n === void 0 && (n = new Int32Array(t), To[t] = n);
...
function Po(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2f(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (Ao(n, t)) return;
		e.uniform2fv(this.addr, t), jo(n, t);
	}
}
function Fo(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3f(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (Ao(n, t)) return;
		e.uniform3fv(this.addr, t), jo(n, t);
	}
}
function Io(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (Ao(n, t)) return;
		e.uniform4fv(this.addr, t), jo(n, t);
	}
}
function Lo(e, t) {
	...
	if (r === void 0) {
		if (Ao(n, t)) return;
		e.uniformMatrix2fv(this.addr, !1, t), jo(n, t);
	} else {
		if (Ao(n, r)) return;
		Oo.set(r), e.uniformMatrix2fv(this.addr, !1, Oo), jo(n, r);
	}
}
function Ro(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (Ao(n, t)) return;
		e.uniformMatrix3fv(this.addr, !1, t), jo(n, t);
	} else {
		if (Ao(n, r)) return;
		Do.set(r), e.uniformMatrix3fv(this.addr, !1, Do), jo(n, r);
	}
}
function zo(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (Ao(n, t)) return;
		e.uniformMatrix4fv(this.addr, !1, t), jo(n, t);
	} else {
		if (Ao(n, r)) return;
		Eo.set(r), e.uniformMatrix4fv(this.addr, !1, Eo), jo(n, r);
	}
}
function Bo(e, t) {
	let n = this.cache;
...
function Jo(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (bo.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = bo) : a = yo, n.setTexture2D(t || a, i);
}
function Yo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || So, i);
}
function Xo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || Co, i);
}
function Zo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || xo, i);
}
function Qo(e) {
	switch (e) {
		case 5126: return No;
		...
		case 35666: return Io;
		case 35674: return Lo;
		case 35675: return Ro;
		case 35676: return zo;
		case 5124:
		case 35670: return Bo;
		case 35667:
		case 35671: return Vo;
		case 35668:
		case 35672: return Ho;
		case 35669:
		case 35673: return Uo;
		case 5125: return Wo;
		case 36294: return Go;
		case 36295: return Ko;
		case 36296: return qo;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return Jo;
		case 35679:
		case 36299:
...
function es(e, t) {
	let n = ko(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function ts(e, t) {
	let n = ko(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function ns(e, t) {
	let n = ko(t, this.size, 4);
...
function is(e, t) {
	let n = ko(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function as(e, t) {
	let n = ko(t, this.size, 16);
...
function ms(e, t, n) {
	let r = this.cache, i = t.length, a = Mo(n, i);
	Ao(r, a) || (e.uniform1iv(this.addr, a), jo(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? bo : yo;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function hs(e, t, n) {
	let r = this.cache, i = t.length, a = Mo(n, i);
	Ao(r, a) || (e.uniform1iv(this.addr, a), jo(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || So, a[e]);
}
function gs(e, t, n) {
	let r = this.cache, i = t.length, a = Mo(n, i);
	Ao(r, a) || (e.uniform1iv(this.addr, a), jo(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || Co, a[e]);
}
function _s(e, t, n) {
	let r = this.cache, i = t.length, a = Mo(n, i);
	Ao(r, a) || (e.uniform1iv(this.addr, a), jo(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || xo, a[e]);
}
function vs(e) {
	switch (e) {
		case 5126: return $o;
		case 35664: return es;
		case 35665: return ts;
		case 35666: return ns;
		case 35674: return rs;
		case 35675: return is;
		case 35676: return as;
		case 5124:
		case 35670: return os;
		case 35667:
		case 35671: return ss;
		case 35668:
		case 35672: return cs;
		case 35669:
		case 35673: return ls;
		case 5125: return us;
		case 36294: return ds;
		case 36295: return fs;
		case 36296: return ps;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		...
		case 36300:
		case 36308:
		case 36293: return gs;
		case 36289:
		case 36303:
		case 36311:
		case 36292: return _s;
	}
}
var ys = class {
	constructor(e, t, n) {
	...
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = vs(t.type);
	}
}, xs = class {
	constructor(e) {
...
function ws(e, t, n) {
	...
	for (Ss.lastIndex = 0;;) {
		let a = Ss.exec(r), o = Ss.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Cs(n, l === void 0 ? new ys(s, e, t) : new bs(s, e, t));
			break;
		}
		{
			let e = n.map[s];
			e === void 0 && (e = new xs(s), Cs(n, e)), n = e;
		}
	}
}
var Ts = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			ws(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var As = /*@__PURE__*/ new J();
function js(e) {
	Y._getMatrix(As, Y.workingColorSpace, e);
	let t = `mat3( ${As.elements.map((e) => e.toFixed(4))} )`;
...
var Is = /*@__PURE__*/ new q();
function Ls() {
	return Y.getLuminanceCoefficients(Is), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${Is.x.toFixed(4)}, ${Is.y.toFixed(4)}, ${Is.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function Rs(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(Vs).join("\n");
}
function zs(e) {
	let t = [];
	for (let n in e) {
...
var Ws = /^[ \t]*#include +<([\w\d./]+)>/gm;
function Gs(e) {
	return e.replace(Ws, qs);
}
...
function tc(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : ec[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var nc = { 302: "ENVMAP_MODE_REFRACTION" };
function rc(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : nc[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var ic = {
...
function ac(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : ic[e.combine] || "ENVMAP_BLENDING_NONE";
}
function oc(e) {
...
function sc(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = $s(n), l = tc(n), u = rc(n), d = ac(n), f = oc(n), p = Rs(n), m = zs(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : Fs("toneMapping", n.toneMapping),
		n.dithering ? "#define DITHERING" : "",
		n.opaque ? "#define OPAQUE" : "",
		Z.colorspace_pars_fragment,
		Ns("linearToOutputTexel", n.outputColorSpace),
		Ls(),
	...
	let y = v + g + o, b = v + _ + s, x = Es(i, i.VERTEX_SHADER, y), S = Es(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) {
				if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
					...
					let e = Ms(i, x, "vertex"), n = Ms(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new Ts(i, h), T = Bs(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, Ds)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Os++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var cc = 0, lc = class {
	constructor() {
	...
	constructor(e) {
		this.id = cc++, this.code = e, this.usedTimes = 0;
	}
};
function dc(e) {
...
function fc(e, t, n, r, i, a) {
	let o = new an(), s = new lc(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let R = {
			...
			packedNormalMap: ae && i.normalMapType === 0 && dc(i.normalMap.format),
			metalnessMap: I,
			roughnessMap: ce,
			anisotropy: le,
			anisotropyMap: he,
	...
	function y(e) {
		...
		if (t) {
			let e = Na[t];
			n = wi.clone(e.uniforms);
		} else n = e.uniforms;
		return n;
	}
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new sc(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function gc() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || mc), r.length > 1 && r.sort(t || hc), i.length > 1 && i.sort(t || hc), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function _c() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new gc(), e.set(t, [i])) : n >= r.length ? (i = new gc(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function wc(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Cc(e), t.set(n, [a])) : r >= i.length ? (a = new Cc(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var Tc = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Ec = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Dc = [
	...
	/*@__PURE__*/ new q(0, -1, 0),
	/*@__PURE__*/ new q(0, -1, 0)
], kc = /*@__PURE__*/ new qt(), Ac = /*@__PURE__*/ new q(), jc = /*@__PURE__*/ new q();
function Mc(e, t, n) {
	let r = new ii(), i = new K(), o = new K(), s = new Ht(), l = new ki(), u = new Ai(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Di({
			...
			if (n.isDepthTexture) u = j(n.format === O, n.type), _ && (g ? d.texStorage2D(e.TEXTURE_2D, 1, u, t.width, t.height) : d.texImage2D(e.TEXTURE_2D, 0, u, t.width, t.height, 0, c, l, null));
							...
							if (g) {
								if (v) {
									if (n.layerUpdates.size > 0) {
										let t = ka(f.width, f.height, n.format, n.type);
				...
				if (g) {
					if (_ && d.texStorage3D(e.TEXTURE_2D_ARRAY, y, u, t.width, t.height, t.depth), v) {
						if (n.layerUpdates.size > 0) {
							let r = ka(t.width, t.height, n.format, n.type);
							for (let i of n.layerUpdates) {
...
var Ic = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Lc = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Rc = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new Di({
				vertexShader: Ic,
				fragmentShader: Lc,
				uniforms: {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, f = null, p = null, m = null, h = typeof XRWebGLBinding < "u", _ = new Rc(), v = {}, y = t.getContextAttributes(), b = null, S = null, C = [], w = [], T = new K(), k = null, A = new aa();
		A.viewport = new Ht();
		let j = new aa();
		j.viewport = new Ht();
		let ee = [A, j], M = new ua(), N = null, P = null;
...
}, Bc = /*@__PURE__*/ new qt(), Vc = /*@__PURE__*/ new J();
...
function Hc(e, t) {
	...
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Ci(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(Bc.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(Vc), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function Kc() {
	return Gc === null && (Gc = new Xr(Wc, 16, 16, j, v), Gc.name = "DFG_LUT", Gc.minFilter = c, Gc.magFilter = c, Gc.wrapS = r, Gc.wrapT = r, Gc.generateMipmaps = !1, Gc.needsUpdate = !0), Gc;
}
var qc = class {
	constructor(e = {}) {
		...
		function rt() {
			R = new uo(L), R.init(), et = new Fc(L, R), Ne = new Ba(L, R, e, et), z = new Nc(L, R), Ne.reversedDepthBuffer && p && z.buffers.depth.setReversed(!0), re = L.createFramebuffer(), ie = L.createFramebuffer(), ae = L.createFramebuffer(), Pe = new mo(L), B = new pc(), V = new Pc(L, R, z, B, Ne, et, Pe), Fe = new lo(F), Le = new Ma(L), tt = new Ra(L, Le), Re = new fo(L, Le, Pe, tt), ze = new go(L, Re, Le, tt, Pe), Xe = new ho(L, Ne, V), Ge = new Va(B), Be = new fc(F, Fe, R, Ne, tt, Ge), Ve = new Hc(F, B), Ue = new _c(), We = new wc(R), Ye = new La(F, Fe, z, ze, _, s), qe = new Mc(F, ze, Ne), nt = new Uc(L, Pe, Ne, z), Qe = new za(L, R, Pe), $e = new po(L, R, Pe), Pe.programs = Be.programs, F.capabilities = Ne, F.extensions = R, F.properties = B, F.renderLists = Ue, F.shadowMap = qe, F.state = z, F.info = Pe;
		}
		rt(), S !== 1009 && (P = new vo(S, t.width, t.height, o, r, i));
		let W = new zc(F, L);
		...
		function xt(e) {
			if (e.uniformsList === null) {
				...
				e.uniformsList = Ts.seqWithValue(t.seq, e.uniforms);
			}
		...
		function wt(e, t, n, r, i) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Xe.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(L, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = Kc()), C) {
				...
				Ts.upload(L, xt(v), E, V);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Ts.upload(L, xt(v), E, V), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(L, "center", i.center), T.setValue(L, "modelViewMatrix", i.modelViewMatrix), T.setValue(L, "normalMatrix", i.normalMatrix), T.setValue(L, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
...
}, Jc = { type: "change" }, Yc = { type: "start" }, Xc = { type: "end" }, Zc = new Pr(), Qc = new ei(), $c = Math.cos(70 * wt.DEG2RAD), el = new q(), tl = 2 * Math.PI, $ = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(Jc), this.update(), this.state = $.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		if (el.setFromSpherical(this._spherical), el.applyQuaternion(this._quatInverse), t.copy(this.target).add(el), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			let e = null;
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = el.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (Zc.origin.copy(this.object.position), Zc.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(Zc.direction)) < $c ? this.object.lookAt(this.target) : (Qc.setFromNormalAndCoplanarPoint(this.object.up, this.target), Zc.intersectPlane(Qc, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > nl || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > nl || this._lastTargetPosition.distanceToSquared(this.target) > nl ? (this.dispatchEvent(Jc), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? tl / 60 / 60 * this.autoRotateSpeed : tl / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_panLeft(e, t) {
		el.setFromMatrixColumn(t, 0), el.multiplyScalar(-e), this._panOffset.add(el);
	}
	_panUp(e, t) {
		this.screenSpacePanning === !0 ? el.setFromMatrixColumn(t, 1) : (el.setFromMatrixColumn(t, 0), el.crossVectors(this.object.up, el)), el.multiplyScalar(e), this._panOffset.add(el);
	}
	_pan(e, t) {
		let n = this.domElement;
		if (this.object.isPerspectiveCamera) {
			let r = this.object.position;
			el.copy(r).sub(this.target);
			let i = el.length();
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(tl * this._rotateDelta.x / t.clientHeight), this._rotateUp(tl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(tl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-tl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(tl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
			case this.keys.RIGHT: e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(-tl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(-this.keyPanSpeed, 0), t = !0;
		}
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(tl * this._rotateDelta.x / t.clientHeight), this._rotateUp(tl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function ol(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(Xc), this.state = $.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function sl(t) {
	...
	this.state !== $.NONE && this.dispatchEvent(Yc);
}
function cl(e) {
	switch (this.state) {
		case $.ROTATE:
...
function ll(e) {
	this.enabled !== !1 && this.enableZoom !== !1 && this.state === $.NONE && (e.preventDefault(), this.dispatchEvent(Yc), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(Xc));
}
function ul(e) {
...
//#endregion
//#region src/globe.js
var gl, _l, vl, yl, bl, xl = new wa(), Sl = new K(), Cl = [], wl;
function Tl(e, t, n) {
	wl = n, gl = new An(), bl = new Sn(), gl.add(bl), _l = new aa(45, e.clientWidth / e.clientHeight, .1, 1e3), _l.position.z = 3, vl = new qc({ antialias: !0 }), vl.setSize(e.clientWidth, e.clientHeight), vl.setPixelRatio(window.devicePixelRatio), e.appendChild(vl.domElement), vl.domElement.addEventListener("click", Ol), new rl(_l, vl.domElement);
	let r = new wr(), i = 15e3, a = new Float32Array(i * 3);
	for (let e = 0; e < i * 3; e++) a[e] = (Math.random() - .5) * 100;
	r.setAttribute("position", new lr(a, 3));
	let o = new ui(r, new ai({
		color: 16777215,
		size: .05
	}));
	gl.add(o), yl = new qr(new vi(1, 64, 64), new Fr({ map: new Zi().load("/textures/earth.jpg") })), gl.add(yl), El(t), Al();
}
function El(e) {
	for (let t of e) {
		let e = Dl(t.latitude, t.longitude), n = new qr(new vi(.015, 16, 16), new Fr({ color: 16711680 }));
		n.userData = {
			circuitName: t.name,
			circuitId: t.id
		}, n.position.copy(e), Cl.push(n), bl.add(n);
	}
}
function Dl(e, t) {
...
function Ol(e) {
	...
	Sl.x = (e.clientX - t.left) / t.width * 2 - 1, Sl.y = -((e.clientY - t.top) / t.height) * 2 + 1, xl.setFromCamera(Sl, _l);
	let n = xl.intersectObjects(Cl);
	if (n.length === 0) return;
	let r = n[0].object;
	wl.invokeMethodAsync("CircuitClicked", r.userData.circuitName, r.userData.circuitId);
}
function kl(e) {
	bl.clear(), Cl.length = 0, El(e);
}
function Al() {
	requestAnimationFrame(Al), vl.render(gl, _l);
}
window.globe = {
	initGlobe: Tl,
	updateCircuits: kl
...
//#endregion
export { Tl as initGlobe, kl as updateCircuits };
