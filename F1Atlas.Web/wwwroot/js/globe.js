...
function yi(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (xi(i)) i.isRenderTargetTexture ? (V("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
Li.prototype.ValueTypeName = "", Li.prototype.TimeBufferType = Float32Array, Li.prototype.ValueBufferType = Float32Array, Li.prototype.DefaultInterpolation = L;
var Ri = class extends Li {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ri.prototype.ValueTypeName = "bool", Ri.prototype.ValueBufferType = Array, Ri.prototype.DefaultInterpolation = Ne, Ri.prototype.InterpolantFactoryMethodLinear = void 0, Ri.prototype.InterpolantFactoryMethodSmooth = void 0;
...
Ui.prototype.ValueTypeName = "string", Ui.prototype.ValueBufferType = Array, Ui.prototype.DefaultInterpolation = Ne, Ui.prototype.InterpolantFactoryMethodLinear = void 0, Ui.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Ha = 4, Ua = [
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		m > Wa && V(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Wa}`);
		let h = [], g = 0;
		for (let e = 0; e < Wa; ++e) {
...
function fc(e, t, n, r, i, a) {
	...
	function h(i, o, l, u, h, g) {
		...
		let L = {
			...
			packedNormalMap: oe && i.normalMapType === 0 && dc(i.normalMap.format),
			metalnessMap: F,
			roughnessMap: le,
			anisotropy: ue,
			anisotropyMap: ge,
...
var Ic = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Lc = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Rc = class {
	...
	constructor(e, t) {
		...
		let j = new aa();
		j.viewport = new Ht();
		let ee = [A, j], M = new ua(), te = null, N = null;
	...
	constructor(e = {}) {
		...
		function wt(e, t, n, r, i) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Ze.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(I, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = Kc()), C) {
				...
				Ts.upload(I, xt(v), E, B);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Ts.upload(I, xt(v), E, B), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(I, "center", i.center), T.setValue(I, "modelViewMatrix", i.modelViewMatrix), T.setValue(I, "normalMatrix", i.normalMatrix), T.setValue(I, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
...
//#endregion
//#region src/globe.js
var gl, _l, vl, yl, bl = new wa(), xl = new K(), Sl = [], Cl;
function wl(e, t, n) {
	Cl = n, gl = new An(), _l = new aa(45, e.clientWidth / e.clientHeight, .1, 1e3), _l.position.z = 3, vl = new qc({ antialias: !0 }), vl.setSize(e.clientWidth, e.clientHeight), vl.setPixelRatio(window.devicePixelRatio), e.appendChild(vl.domElement), vl.domElement.addEventListener("click", El), new rl(_l, vl.domElement);
...
function El(e) {
	...
	xl.x = (e.clientX - t.left) / t.width * 2 - 1, xl.y = -((e.clientY - t.top) / t.height) * 2 + 1, bl.setFromCamera(xl, _l);
...
window.globe = { initGlobe: wl };
//#endregion
export { wl as initGlobe };
